...
class JdspiderPipeline(object):
    ...
    def _insert_product_record(self, cursor, item):
        ...
        #                      """
        update_sql="""update product_item set original_price='%s',really_price='%s' where product_id = '%d'  
        """
        sqlOpt = "update product_item set original_price='%s',really_price='%s' where product_id = '%d'" % (
            original_price,
